...
namespace IIS.Prilozhenie_5
{
    ...
    public class Серверная : ICSSoft.STORMNET.DataObject
    {
        ...
        private int fIDСерверной;
        
        private IIS.Prilozhenie_5.Сотрудник fСотрудник;
        
        private IIS.Prilozhenie_5.DetailArrayOfКонтроллер fКонтроллер;
        ...
        /// IDСерверной.
        /// </summary>
        // *** Start programmer edit section *** (Серверная.IDСерверной CustomAttributes)

        // *** End programmer edit section *** (Серверная.IDСерверной CustomAttributes)
        public virtual int IDСерверной
        {
            get
            {
                // *** Start programmer edit section *** (Серверная.IDСерверной Get start)

                // *** End programmer edit section *** (Серверная.IDСерверной Get start)
                int result = this.fIDСерверной;
                // *** Start programmer edit section *** (Серверная.IDСерверной Get end)

                // *** End programmer edit section *** (Серверная.IDСерверной Get end)
                return result;
            }
            set
            {
                // *** Start programmer edit section *** (Серверная.IDСерверной Set start)

                // *** End programmer edit section *** (Серверная.IDСерверной Set start)
                this.fIDСерверной = value;
                // *** Start programmer edit section *** (Серверная.IDСерверной Set end)

                // *** End programmer edit section *** (Серверная.IDСерверной Set end)
            }
        }
        ...
        [PropertyStorage(new string[] {
                "Сотрудник"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_5.Сотрудник Сотрудник
        {
            get
            {
                ...
                IIS.Prilozhenie_5.Сотрудник result = this.fСотрудник;
        ...
        public virtual IIS.Prilozhenie_5.DetailArrayOfКонтроллер Контроллер
        {
            get
            {
                ...
                {
                    this.fКонтроллер = new IIS.Prilozhenie_5.DetailArrayOfКонтроллер(this);
                }
                IIS.Prilozhenie_5.DetailArrayOfКонтроллер result = this.fКонтроллер;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СервернаяE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяE", typeof(IIS.Prilozhenie_5.Серверная));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СервернаяL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СервернаяL", typeof(IIS.Prilozhenie_5.Серверная));
                }
            }
        }
    }
