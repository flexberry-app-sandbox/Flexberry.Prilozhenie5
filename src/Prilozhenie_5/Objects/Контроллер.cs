...
namespace IIS.Prilozhenie_5
{
    ...
    public class Контроллер : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_5.Сенсоры fСенсоры;
        ...
        [PropertyStorage(new string[] {
                "Сенсоры"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_5.Сенсоры Сенсоры
        {
            get
            {
                ...
                IIS.Prilozhenie_5.Сенсоры result = this.fСенсоры;
        ...
        /// <summary>
        /// мастеровая ссылка на шапку IIS.Prilozhenie_5.Серверная.
        /// </summary>
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View КонтроллерE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("КонтроллерE", typeof(IIS.Prilozhenie_5.Контроллер));
                }
            }
        }
    }
    ...
    public class DetailArrayOfКонтроллер : ICSSoft.STORMNET.DetailArray
    {
        ...
        // *** Start programmer edit section *** (IIS.Prilozhenie_5.DetailArrayOfКонтроллер members)

        // *** End programmer edit section *** (IIS.Prilozhenie_5.DetailArrayOfКонтроллер members)
        ...
        /// </summary>
        public DetailArrayOfКонтроллер(IIS.Prilozhenie_5.Серверная fСерверная) : 
                base(typeof(Контроллер), ((ICSSoft.STORMNET.DataObject)(fСерверная)))
        {
        }
        
        public IIS.Prilozhenie_5.Контроллер this[int index]
        {
            get
            {
                return ((IIS.Prilozhenie_5.Контроллер)(this.ItemByIndex(index)));
            }
        }
        
        public virtual void Add(IIS.Prilozhenie_5.Контроллер dataobject)
        {
